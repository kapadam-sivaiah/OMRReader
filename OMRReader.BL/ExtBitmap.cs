...
namespace OMRReader.BL
{
    ...
    {
        public static int ImageLeft {get;set;}
        public static int ImageTop { get; set; }
        //public ExtBitmap(int imageLeft,int imageTop)
        //{
                                                 ...
                                                 bool grayscale = false)
        {
            ...
            for (int offsetY =ImageTop; offsetY <
                sourceBitmap.Height - filterOffset; offsetY++)
            {
                for (int offsetX =ImageLeft; offsetX <
                    ImageLeft +20; offsetX++)
                {
                    blueX = greenX = redX = 0;
                    blueY = greenY = redY = 0;
                    ...
                    double black = blueTotal + greenTotal + redTotal;
                    if (black == 0)
                    {
                        //black =255;
                        //redTotal = 255;
                  ...
                  if(black>900)
                    ...
                    resultBuffer[byteOffset + 3] = (byte)(black);
